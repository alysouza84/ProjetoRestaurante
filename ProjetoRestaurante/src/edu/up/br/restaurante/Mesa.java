...
public class Mesa {
    ...
    private static final String FILE_NAME = "C:\\Users\\Lucas\\Documents\\GitHub\\ProjetoRestaurante\\src\\edu\\up\\br\\restaurante\\arquivos\\mesas.txt";
        ...
        if (file.exists()) {
            ...
            try {
                if (file.createNewFile()) {
                    System.out.println("Arquivo de mesas criado com sucesso.");
                } else {
                    System.out.println("Falha ao criar o arquivo de mesas.");
                }
            } catch (IOException e) {
                System.out.println("Erro ao criar o arquivo de mesas.");
                e.printStackTrace();
            }
            salvarMesa();
        }
